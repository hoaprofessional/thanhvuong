...
namespace Framework.Context.Migrations
{
    ...
    [Migration("20180909081428_addQoutationSendNotification")]
    partial class addQoutationSendNotification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Framework.Models.NotificationManagement.QoutationSendNotificationConfig", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(450);

                    b.Property<string>("QoutationStatus");

                    b.Property<string>("SendtoPermission");

                    b.HasKey("Id");

                    b.ToTable("QoutationSendNotificationConfigs");
                });
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpectedReturnGoodDate");
                    ...
                    b.Property<bool?>("StopUpdateExpectedReturnGoodDate");
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.OrderProcessedInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("OrderStatusStaffCreated");
                    ...
                    b.ToTable("OrderProcessedInterested");
                });
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.OrderStatusWaitingApprovalInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("OrderStatusWaitingApprovalInterested");
                });

            modelBuilder.Entity("Framework.Models.QoutationManagement.OrderStatusWaitingProcessInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("OrderStatusWaitingProcessInterested");
                });
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.Qoutation", b =>
                {
                    ...
                    b.Property<double>("TotalPriceBuy");

                    b.Property<double>("TotalPriceSell");
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.QoutationDetail", b =>
                {
                    ...
                    b.Property<double>("TotalPriceBuy")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasComputedColumnSql("(VATBuy*UnitPriceBuy + UnitPriceBuy)*ProductQuantity");

                    b.Property<double>("TotalPriceSell")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasComputedColumnSql("(VATSell*UnitPriceSell + UnitPriceSell)*ProductQuantity");

                    b.Property<decimal>("UnitPriceBuy");

                    b.Property<decimal>("UnitPriceSell");

                    b.Property<double>("VATBuy");

                    b.Property<double>("VATSell");
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.QuotesProcessedInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("QoutationStatusStaffCreated");

                    b.HasKey("Id");

                    b.ToTable("QuotesProcessedInterested");
                });

            modelBuilder.Entity("Framework.Models.QoutationManagement.QuotesStatusWaitingApprovalInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("QuotesStatusWaitingApprovalInterested");
                });

            modelBuilder.Entity("Framework.Models.QoutationManagement.QuotesStatusWaitingProcessInterested", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("QuotesStatusWaitingProcessInterested");
                });
            ...
            modelBuilder.Entity("Framework.Models.TaskManagement.AssignWorkUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("AssignerRole")
                        .HasMaxLength(100);
            ...
            modelBuilder.Entity("Framework.Models.TaskManagement.Task", b =>
                {
                    ...
                    b.HasOne("Framework.Models.UserManagement.ApplicationUser", "Assigner")
                        .WithMany()
