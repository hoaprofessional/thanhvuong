...
namespace Framework.Context.Migrations
{
    ...
    [Migration("20180806080057_AddQoutationStatusData")]
    partial class AddQoutationStatusData
    {
            ...
            modelBuilder.Entity("Framework.Models.QoutationManagement.QoutationDetail", b =>
                {
                    ...
                    b.Property<decimal>("TotalPrice")
                        ...
                        .HasComputedColumnSql("([VAT] + [DeliveryPrice] + [InstallationPrice] + [UnitPrice])*[ProductQuantity]");
